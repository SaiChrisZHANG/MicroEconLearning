...
\begin{definition}
    ...
    \begin{enumerate}
        ...
        \item[-] $C(\cdot)$ is a \textit{choice rule correspondence} that assigns a nonempty set of chosen elements $C(B)\subset B$, $\forall B\in \mathcal{B}$\footnote{The choice set $C(B)$}.
    \end{enumerate}
\end{definition}