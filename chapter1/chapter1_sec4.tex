...
\begin{theorem}\label{thm_rational_has_utility_countable}
    $\succsim$ is rational and $X$ is \textbf{countable} $\Rightarrow$ there is a utility function with range $(-1,1)$ representing $\succsim$.
\end{theorem}

To prove Thm.\ref{thm_rational_has_utility_countable}, we can construct a utility function as:
