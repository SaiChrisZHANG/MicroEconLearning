...
But here we assume the Lagrangean multiplier is fixed across all commodities, which is a very strict assumption. Think Lagrangean multiplier as a penalty mechanism,  An alternative way of setting the Lagrange multiplier is 
