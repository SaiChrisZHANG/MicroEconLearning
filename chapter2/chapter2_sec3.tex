...
\begin{enumerate}
    ...
    \begin{enumerate} 
        \item[-] the concavity of $e(\cdot,u)$ is equivalent to the convexity of $\left\{ (\mathbf{p},w)\mid e(\mathbf{p},u)\geq w \right\}$
        \item[-] the quasi-convexity of $v(\cdot)$ is equivalent to the convexity of the set $\left\{(\mathbf{p},w)\mid v(\mathbf{p},w)\leq u \}$ 
    \end{enumerate}
    By \ref{prop:expenditure_and_indirectuility} and monotonicity, $v(\mathbf{p},w)\leq u \Leftrightarrow e(\mathbf{p},u)\geq w$, hence, the two sets are equivalent for any $u$.
    ...
    \end{enumerate} 
    again, by \ref{prop:expenditure_and_indirectuility} and monotonicity, $v(\mathbf{p},w)\leq u \Leftrightarrow e(\mathbf{p},u)\geq w$ and $v(\mathbf{p},w)\geq u \Leftrightarrow e(\mathbf{p},u)\leq w$, hence the two continuity conditions are equivalent.
\end{enumerate}
