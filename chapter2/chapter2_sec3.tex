...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item[iv] \myhl[red]{\underline{\textbf{Continuity}}}: $e(\mathbf{p},u)$ is \textit{\textbf{continuous}} in $\mathbf{p}$ and $u$: to prove continuity, we need to prove that $\forall \left\{\left(p^n,u^n\right)\right\}^{\infty}_{n=1}\right (p,u)$, $\forall w$,  $e(p^n,u^n)\leq w\Rightarrow e(p^n,u^n)\leq w$ and $e(p^n,u^n)\geq w\Rightarrow e(p^n,u^n)\geq w$.
    \end{enumerate} 
\end{enumerate}
