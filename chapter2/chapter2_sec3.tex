...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item[iii] \myhl[red]{\underline{\textbf{Concavity}}}: $e(\mathbf{p},u)$ is \textit{\textbf{concave}} in $\mathbf{p}$: 
        \item[iv] \myhl[red]{\underline{\textbf{Continuity}}}: $e(\mathbf{p},u)$ is \textit{\textbf{continuous}} in $\mathbf{p}$ and $u$
    \end{enumerate} 
\end{enumerate}
