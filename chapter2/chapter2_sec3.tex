...
\begin{enumerate}
    \item[-] $\succsim$ is \textbf{rational}:
    \begin{enumerate}
    ...
    \item[-] $\succsim$ is desirable. It is reasonable to assume that larger amounts of commodities are preferred. So basically, the more the better.
