...
In summary, the duality between UMP and EMP have been established, and the four objects are interlinked with each other through the aforementioned properties:
\begin{figure}
    \centering
