...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item[i] \myhl[blue]{\underline{\textbf{Homogeneity}}}. $v(\mathbf{p},w)$ is \textit{\textbf{homogeneous of degree zero}} in $(\mathbf{p},w)$: define $u=v(\mathbf{p},w)$ then $e(\mathbf{p},u)=w$
        ...
        \end{enumerate}
        \item[iii] \myhl[blue]{\underline{\textbf{Quasiconvexity}}}. $\forall \bar{v}$, the set $\left\{(\mathbf{p},w):v(\mathbf{p},w)\leq \bar{v}\right\}$ is \textit{\textbf{convex}}.
        \item[iv] \myhl[blue]{\underline{\textbf{Continuity}}}. $v(\mathbf{p},w)$ is \textit{\textbf{continuous}} in $\mathbf{p}$ and $w$.
    \end{enumerate} 
\end{enumerate}
