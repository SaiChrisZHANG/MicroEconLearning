...
A very important property of Hicksian demand is that it satisfies \myhl[blue]{\textbf{compensated law of demand}}:
...
Although this looks familiar, as in Thm.\ref{thm:compensated_lawofdemand} and Thm.\ref{thm:compensated_lawofdemand_general} for Walrasian demand. However, Walrasian demand does NOT necessarily satisfy the law of demand: for Walrasian demand to do so, it must satisfy WARP as well.

\subsubsection*{Duality: EMP and UMP}

We will discuss duality more thoroughly and in more aspects in Chapter , here, we focus on the duality of EMP and UMP.
