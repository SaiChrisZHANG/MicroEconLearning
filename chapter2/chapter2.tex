...
The major conclusion of choice-based consumer theory is that WARP is essentially equivalent to the \textit{compensated law of demand}, but WARP imposes fewer restrictions on demand than preference-based theory,
...
\input{chapter2/chapter2_sec2.tex}

\section{Preference Based Consumer Theory}\label{chap2:sec3}
\input{chapter2/chapter2_sec3.tex}

\section{Problems of Revealed Preferences}\label{chap2:sec4}
\input{chapter2/chapter2_sec4.tex}

\section{Welfare Analysis and Money Metrics}\label{chap2:sec5}
\input{chapter2/chapter2_sec5.tex}
